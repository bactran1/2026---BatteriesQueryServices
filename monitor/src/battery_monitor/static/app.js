...
const translations = {
  en: {
    ...
    "energy.chargingDescription": "{rate} is measured entering {packs}. Grid and home values require inverter telemetry.",
    "energy.dischargingDescription": "{rate} is measured leaving {packs} through the inverter. Grid and home values require inverter telemetry.",
    "energy.idleDescription": "Battery telemetry shows no significant transfer. Grid and home meters are not connected yet.",
  ...
  vi: {
    ...
    "energy.pack": "bộ pin",
    "energy.packs": "bộ pin",
    "energy.chargingDescription": "Đo được {rate} đang đi vào {packs}. Giá trị điện lưới và phụ tải cần dữ liệu từ biến tần.",
    "energy.dischargingDescription": "Đo được {rate} đang rời {packs} qua biến tần. Giá trị điện lưới và phụ tải cần dữ liệu từ biến tần.",
    "energy.idleDescription": "Dữ liệu pin không ghi nhận truyền tải đáng kể. Chưa kết nối đồng hồ điện lưới và phụ tải.",
