...
- `BQM_WEATHER_ENABLED`, `BQM_WEATHER_LATITUDE`, `BQM_WEATHER_LONGITUDE`, and `BQM_WEATHER_LOCATION`; current conditions are cached from Open-Meteo for the Live Home Energy display
