...
class FrontendContractTests(unittest.TestCase):
    ...
    def test_three_dimensional_energy_flow_is_live_and_resilient(self) -> None:
        ...
        self.assertIn("function createUtilityGrid", scene)
        self.assertIn("function createInverter", scene)
        self.assertIn("function createHomeLoad", scene)
        self.assertIn("function createHomeFlowNetwork", scene)
        ...
        self.assertIn('canvas.dataset.topology = "grid-inverter-battery-load"', scene)
