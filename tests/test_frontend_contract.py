...
class FrontendContractTests(unittest.TestCase):
    ...
    def test_energy_history_has_hour_date_month_and_year_views(self) -> None:
        ...
        self.assertIn('energyChart.addEventListener("pointermove"', javascript)
        ...
        self.assertIn('ctx.fillText(`${index * 6}h`', javascript)
    ...
    def test_power_history_overlays_inverter_sources_and_demand(self) -> None:
        ...
        self.assertIn('state.range === "date" ? `${index * 6}h`', javascript)
